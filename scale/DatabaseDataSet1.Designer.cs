...
namespace scale {
    ...
    public partial class DatabaseDataSet1 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public UsersRow AddUsersRow(string user_id, string password) {
...
namespace scale.DatabaseDataSet1TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [Users] WHERE (([user_id] = @Original_user_id) AND ((@IsNull_password" +
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Users] ([user_id], [password]) VALUES (@user_id, @password);\r\nSELECT" +
                " user_id, password FROM Users WHERE (user_id = @user_id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Users] SET [user_id] = @user_id, [password] = @password WHERE (([user_id] = @Original_user_id) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT user_id, password FROM Users WHERE (user_id = @user_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::scale.Properties.Settings.Default.DatabaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        user_id, password\r\nFROM            Users\r\nWHERE        (password = " +
                "@parameter1)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@p", global::System.Data.SqlDbType.NChar, 12, global::System.Data.ParameterDirection.Input, 0, 0, "password", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT password, user_id FROM Users";
        ...
        public virtual int Fill(DatabaseDataSet1.UsersDataTable dataTable, string p) {
        ...
        public virtual DatabaseDataSet1.UsersDataTable GetData(string p) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((p == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
        ...
        public virtual int FillBy(DatabaseDataSet1.UsersDataTable dataTable) {
